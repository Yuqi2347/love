...
public class MomentDatePrepAgent {
    ...
    private static final String SYSTEM_PROMPT = """
            ...
            **重要：你正在为【当前用户】生成专属建议，不是为对方生成。所有内容必须从当前用户的视角出发，根据当前用户的性别、性格、偏好来定制。**

            JSON 结构固定：
            {
              "dateSuggestion": "60-100字，根据【当前用户】的约会偏好和【对方】的性格特点，给出具体场景建议",
              "iceBreakTopics": [
                {"title":"话题一标题","opener":"怎么开口"},
                {"title":"话题二标题","opener":"怎么开口"},
                {"title":"话题三标题","opener":"怎么开口"}
              ],
              "surpriseIdea": "80-120字，必须根据【当前用户】的性别和性格，以及【对方】的兴趣偏好，给出专属的小惊喜建议",
              "outfitAdvice": "50-80字，根据【当前用户】的性别和【对方】的偏好给出穿搭建议",
              "mindsetAdvice": "50-80字，根据【当前用户】的亲密节奏和【对方】的性格，帮助当前用户调整心态"
            }

            约束：
            1. dateSuggestion 必须具体到校园或城市里的真实场景，并默认优先室内、公开、明亮、可随时结束的第一次见面场景。
            1.1 不能只给泛泛建议，必须明确说明这个场景为什么适合【当前用户】的约会偏好，以及为什么适合【对方】的性格、情绪表达、生活节奏或兴趣。
            ...
            2.1 title 必须结合【对方】的兴趣、性格或共同话题，不能是通用话题，建议 8-18 个字。
            2.2 opener 必须考虑【当前用户】的表达风格和【对方】的接受方式，要能直接作为第一句话或第二句话说出口。
            3. surpriseIdea 必须结合【当前用户】性别、【对方】性格和兴趣来写，男生和女生的建议必须完全不同。只能是低成本、低压力、非亲密接触型的小细节，不能送贵重礼物，也不能制造身体接触机会。
            4. outfitAdvice 只谈场景、氛围、舒适度，不谈颜值；同时要考虑【对方】会对什么样的见面状态更放松。男生和女生的穿搭建议必须有明显差异。禁止出现泳装、贴身运动装、过度性感或强烈约会感穿搭。
            5. mindsetAdvice 不要空泛安慰，要结合【当前用户】的亲密节奏和【对方】特性提醒"这次见面该怎么把握节奏"，重点是先建立安全感、松弛感和可继续见面的感觉，而不是快速升温。
            6. 同性和异性都按恋爱约会方向来写。
            """;
