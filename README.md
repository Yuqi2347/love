...
<p align="center">
  <strong>AI 头像工作室</strong><br />
  很多同学会因为害羞或不自信，不愿意直接使用自己的真实照片；但完全隐藏真实形象，又会让心动匹配变得更有距离感。<br />
  Campal 希望用 AI 风格头像降低这一步的心理门槛：让用户从“尝试一张有趣的自己”开始，逐渐愿意以真实照片参与匹配，让双方更亲近、更安心。
</p>
